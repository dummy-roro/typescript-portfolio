  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="container mx-auto z-10">
        {/* Use flex-row on md+ for side-by-side, column on small */}
        <div className="flex flex-col md:flex-row items-center md:items-start gap-12">

          {/* Left side: Terminal-like block */}
          <div className="animate-fade-in inline-block p-6 bg-gray-900 dark:bg-gray-800 rounded-lg border border-gray-700 font-mono text-left max-w-md w-full">
          ...
          {/* Right side: Heading, description, buttons */}
          <div className="text-center md:text-left max-w-xl w-full animate-fade-in">
